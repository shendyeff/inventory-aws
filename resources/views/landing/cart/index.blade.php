                            ...
                            <tbody class="divide-y divide-gray-200 bg-white">
                                ...
                                <tr>
                                    <td class="py-3 px-4 whitespace-nowrap">
                                        <a href="#" class="text-rose-600" onclick="deleteData({{ $cart->id }})">
                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                class="icon icon-tabler icon-tabler-eraser" width="24" height="24"
                                    ...
                                    <td class="py-3 px-4 whitespace-nowrap" colSpan="4">
                                        <div class="flex items-center justify-center h-96">
                                            <div class="text-center">
                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                    class="icon icon-tabler icon-tabler-shopping-cart inline" width="32"
                            ...
                            <div class="flex flex-col gap-4">
                                <div class="flex flex-col gap-y-2">
                                    ...
                                    <input type="text"
                                        ...
                                        placeholder="Rafi Taufiqurrahman" value="{{ Auth::user()->name }}" name="name"
                                        readonly />
                                </div>
                                <div class="flex flex-col gap-y-2">
                                    <label class="text-sm text-gray-700">
